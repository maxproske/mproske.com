    ...
    <>
      ...
      <main id="content" class="content">
        ...
        <section id="style-guide">
          ...
          <p class="description">
            GitHub:{' '}
            <Link href="https://github.com/maxproske/portfolio">
              <a target="_blank">https://github.com/maxproske/portfolio</a>
            </Link>
          </p>

          <section id="table-of-contents" class="section">
            <h2 class="title">Table of contents</h2>
            <h3 class="table-of-contents-title">Brand Identity</h3>
            <ul>
              <li class="description">
                <Link href="#design-ethos">
                  <a>Design Ethos</a>
                </Link>
              </li>
            </ul>
            <h3 class="table-of-contents-title">Interactive Elements</h3>
            <ul>
              <li class="description">
                <Link href="#in-text-links">
                  <a>In-Text Links</a>
                </Link>
              </li>
            </ul>
            <h3 class="table-of-contents-title">Text Styling</h3>
            <ul>
              <li class="description">
                <Link href="#headings">
                  <a>Four Levels of Headings</a>
                </Link>
              </li>
            </ul>
            <h3 class="table-of-contents-title">Combined Elements</h3>
            <ul>
              <li class="description">
                <Link href="#figures">
                  <a>Figures</a>
          ...
          <section id="design-ethos" class="section">
            <h2 class="title">Design Ethos</h2>
            <article>
              <h3>My Audience</h3>
              <p class="description">
          ...
          <section id="interactive-elements" class="section">
            <h2 class="title">Interactive Elements</h2>

            <article id="in-text-links" class="example">
              <h3>In-Text Links</h3>
              <h4>CSS Selectors</h4>
              <p class="description">
                <code>a</code>
          ...
          <section id="text-styling" class="section">
            <h2 class="title">Text Styling</h2>

            <article id="headings" class="example">
              ...
              <pre>
                <code>
                  &lt;h1 class=&quot;heading&quot;&gt;Heading 5rem&lt;/h1&gt;
                  <br />
                  &lt;h2 class=&quot;header&quot;&gt;Header 3.5rem&lt;/h2&gt;
                  <br />
                  &lt;h3 class=&quot;title&quot;&gt;Title 2rem&lt;/h3&gt;
                  <br />
                  &lt;h4 class=&quot;name&quot;&gt;Name 1rem&lt;/h4&gt;
                </code>
              </pre>
              <h4>Rendered Element</h4>
              <div class="heading">Heading 5rem</div>
              <div class="header">Header 3.5rem</div>
              <div class="title">Title 2rem</div>
              <div class="name">Name 1rem</div>
            </article>
          </section>

          <section id="combined-elements" class="section">
            <h2 class="title">Combined Elements</h2>

            <article id="figures" class="example">
              <h3>Figures</h3>
              <h4>CSS Selectors</h4>
              <p class="description">
              ...
              <pre>
                <code>
                  ...
                  <br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&lt;figcaption class=&quot;caption&quot;&gt;Flip The Lip 4
                  Promo&lt;/figcaption&gt;
                  <br />
                  &lt;/figure&gt;
                </code>
              ...
              <h4>Rendered Element</h4>
              <figure class="figure">
                <img class="image" src="/img/six12/ftl4-website.jpg" alt="Flip The Lip" />
                <figcaption class="caption">Flip The Lip 4 Promo</figcaption>
              </figure>
            </article>

            <article id="projects" class="example">
              <h3>Projects</h3>
              <h4>CSS Selectors</h4>
              <p class="description">
              ...
              <pre>
                <code>
                  &lt;a href=&quot;work/sfu/&quot; class=&quot;link&quot; id=&quot;sfu&quot;&gt;
                  <br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&lt;article class=&quot;item&quot;&gt;
                  <br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h3 class=&quot;title&quot;&gt;First Year Computing
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/div&gt;
                  <br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p class=&quot;description&quot;&gt;Simon Fraser
              ...
              <section id="projects-education">
                <div class="grid">
                  <Link href="/work/sfu">
                    <a class="link" id="sfu">
                      <article class="item">
                        <h3 class="title">First Year Computing Science Representative</h3>
                        <div class="logo">
                        ...
                        <p class="description">Simon Fraser University, 2013-2014.</p>
