  ...
  return (
    <>
      ...
      <main id="content" class="content">
        <section id="intro">
          <h1 class="heading">Max Proske</h1>
          <p class="description">
            I'm a{' '}
            <Link href="#my-work">
          ...
          <p class="description">
            <Link href="#about">
              <a>Learn more about me or get in touch</a>
            </Link>
            .
          </p>
        </section>
        ...
        <section id="my-work">
          ...
          <div class="grid">
            <Link href="/work/six12creative/">
              <a class="link" id="six12creative">
                <article class="item">
                  <h3 class="title">Full Stack Web Developer</h3>
                  <div class="logo">
                    <svg viewBox="0 40 500 180" fill="white">
                  ...
                  <p class="description">SIX12 Creative, 2016-present.</p>
        ...
        <section id="projects-education">
          <h2 class="header">Projects & Education</h2>
          <div class="grid">
            <Link href="/work/ivizlab">
              <a class="link" id="ivizlab">
                <article class="item">
                  <h3 class="title">Undergraduate Research Assistant</h3>
                  <div class="logo">
                    <img src="img/ivizlab-logo.png" alt="iVizLab" />
                  </div>
                  <p class="description">iVizLab, 2016.</p>
                  <div class="background-image" />
                </article>
              </a>
            </Link>
            <Link href="/projects/flashflashrevolution">
              <a class="link" id="flashflashrevolution">
                <article class="item">
                  <h3 class="title">Back-End Developer</h3>
                  <div class="logo">
                    <img src="img/ffr-logo.png" alt="Flash Flash Revolution" />
                  </div>
                  <p class="description">Flash Flash Revolution, 2012-present.</p>
                  <div class="background-image" />
                </article>
              </a>
            </Link>
            <Link href="/work/sfu">
              <a class="link" id="sfu">
                <article class="item">
                  ...
                  <div class="logo">
                    <svg viewBox="0 16 108 40" fill="white">
        ...
        <section id="about">
          ...
          <figure class="portrait">
            <img src="img/me_lowres.jpg" data-src="img/me.jpg" class="lazyload blur" alt="Me" />
            <noscript>
          ...
          <p class="description">
            I have a keen interest in combining Computing Science and Human-Computer Interaction principles, to develop
            highly interactive websites and games.
          </p>
          <p class="description">
            I graduated from{' '}
          ...
          <p class="description">
            My hobbies are mainly centered around music-based rhythm games, long-distance running, and Excel
            spreadsheets.
          </p>
        </section>
        ...
        <section id="contact">
          ...
          <p class="description">
            <Link href="mailto:max@mproske.com">
              <a>max@mproske.com</a>
            </Link>
          </p>
          <p class="description">I'd love to chat about job opportunities or projects I’ve worked on.</p>
          <p class="description">
            ...
            and{' '}
            <Link href="https://www.linkedin.com/in/maxproske">
