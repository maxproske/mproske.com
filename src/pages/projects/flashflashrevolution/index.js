    ...
    <>
      ...
      <main id="content" className="content">
        <div className="go-back">
          <Link href="/#projects-education">« Go back</Link>
        </div>

        <section id="work">
          <h1 className="header">Flash Flash Revolution</h1>
          <p className="description">
            <Link href="http://www.flashflashrevolution.com/FFR_the_Game.php" target="_blank">
          ...
          <article className="project">
            ...
            <p className="description">
              ...
              <Link href="https://www.reuters.com/article/us-adobe-systems-flash-idUSKBN1AA22R" target="_blank">
